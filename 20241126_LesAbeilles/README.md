...
| 8h05           | 8h20         | Causerie d'ouverture                      | Raphaël   |
| 8h20           | 9h30         | Activité 1 - Bricolage                    | Morgane   |
| 9h30           | 9h45         | Rangement de la salle d'art               |           |
| 9h45           | 10h05        | Collation                                 |           |
| 10h05          | 10h25        | Récréation à l'extérieur                  |           |
| 10h25          | 10h50        | Activité 2 - Jeux physiques à l'extérieur | Raphaël   |
| 10h50          | 11h00        | Activité 3 - Jeu Quiz                     | Raphaël   |
| 11h00          | 11h10        | Activité 4 - Lecture d'une histoire       | Morgane   |
...
- Qui a déjà vu une abeille ? Où était-elle et que faisait-elle ?
- Quel bruit fait une abeille ?
- Savez-vous pourquoi les abeilles vont de fleur en fleur ?

### Bricolage

Les enfants sont invités à créer leur propre abeille, en choisissant entre deux options :
- **Abeille 2D** : à partir de ronds de carton fournis
- **Abeille 3D** : à partir de rouleaux de papier toilette

**Matériel mis à disposition :**
- Peinture
- Feuilles de couleur (noir, jaune, etc.)
- Papier cuisson légèrement translucide (pour les ailes)
- Colle, ciseaux, etc.
...
Des balles de couleur représentant le pollen sont cachées dans la cour de récréation avant l'activité. Les enfants, transformés en abeilles, doivent partir à la recherche du pollen et le ramener à la ruche (un panier ou un cerceau désigné).

**Règles de base :**
- Chaque abeille ne peut rapporter qu'une seule boule de pollen à la fois
- Les enfants partent en vagues successives (3 lignes), comme les ouvrières qui quittent la ruche progressivement
- Un adulte joue le rôle de la reine et donne le signal de départ à chaque vague

**Version évoluée (par équipes) :**
- Les enfants sont répartis en équipes, chacune associée à une couleur de pollen
